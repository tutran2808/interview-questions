        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <button
              ...
              className="group bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105"
            >
            ...
            <button 
              ...
              className="border border-gray-300 text-gray-600 px-6 py-3 rounded-xl text-base font-medium hover:border-gray-400 hover:bg-gray-50 transition-colors"
            >
              How It Works
            </button>
          </div>
